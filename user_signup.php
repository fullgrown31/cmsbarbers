	...
	if ($_POST) {
	    ...
	    if($error == 0)
	    {
	    	if($confirmpassword == $password)
		    {
				...
				$query = "INSERT INTO admin (username, password, email, hash) VALUES (:username, :password, :email, :hash)";
	...
	<div id = "maincontent">
		...
		<div id="form">
			<form method="post" action="user_signup.php">
		      ...
		      <p>Already a barber? <a href="user_login.php">Login</a></p>
		</div>
	</div>
